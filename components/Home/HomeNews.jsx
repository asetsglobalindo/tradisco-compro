            ...
            <div className="relative z-10 text-white p-6 md:p-8">
              ...
              <div className="mt-6">
                <Link href={`/news/${data?.slug || ""}`}>
                  <button
                    className="px-4 py-2 border border-white/50 rounded text-white hover:bg-white hover:text-black transition-all duration-300 flex items-center gap-2 text-sm"
                  >
                    Read More
                    <ArrowRight size={16} />
                  </button>
